...
void drawBorder(int x=0,int y=0){
	...
	gotoxy((width/2)+x-11,y); cout<<" C O U N T D O W N    B E G I N S"; 
...
int main()
{
	...
	do{
		...
		cout<<endl<<endl;
		cout<<"==================================================="<<endl;
		cout<<"            B R A C E       Y O U R S E L V E S    "<<endl;
		cout<<"==================================================="<<endl<<endl;
		...
		if(hour == 0 && min == 0 && sec == 0){
			gotoxy(10,18);cout<<"PLEASE BE ALRIGHT! NEW YEAR 2021";
			getch();
			break;
		}
		sec--;
	...
	gotoxy(10,20); 
	cout<<"DO YOU WANT TO FORGET 2020(Y/N): ";
	op = getch(); 	 
}	while(op=='y' || op=='Y');
	return 0;
}
